...
ActiveRecord::Schema.define(version: 20140219064910) do
  ...
  create_table "m_ordinary_channels", force: true do |t|
    ...
    t.string   "url"
    t.integer  "state_id"
    t.integer  "m_ordinary_publisher_id"
    t.integer  "tag_ids",                 default: [], array: true
    t.integer  "created_user_id"
    t.integer  "modified_user_id"
  end

  add_index "m_ordinary_channels", ["m_ordinary_publisher_id"], name: "index_m_ordinary_channels_on_m_ordinary_publisher_id", using: :btree
  ...
  create_table "m_ordinary_positions", force: true do |t|
    ...
    t.integer  "tag_ids",                 default: [], array: true
    t.integer  "m_ordinary_publisher_id"
    t.integer  "m_ordinary_channel_id"
  ...
  add_index "m_ordinary_positions", ["m_ordinary_channel_id"], name: "index_m_ordinary_positions_on_m_ordinary_channel_id", using: :btree
  add_index "m_ordinary_positions", ["m_ordinary_publisher_id"], name: "index_m_ordinary_positions_on_m_ordinary_publisher_id", using: :btree
  add_index "m_ordinary_positions", ["name"], name: "index_m_ordinary_positions_on_name", unique: true, using: :btree
  ...
  create_table "m_payment_types", force: true do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "m_serving_types", force: true do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
